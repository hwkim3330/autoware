...
def launch_setup(context, *args, **kwargs):
    ...
    # ROii experimental: concatenate the 4 POST-fault-injector clouds into
    # one base_link cloud BEFORE the ego-body crop. Motion-compensated using the
    # vehicle twist; naive matching (CARLA stamps all four identically).
    nodes.append(
        ComposableNode(
            ...
            remappings=[
                ...
                ("output", "concatenated_raw/pointcloud"),
            ],
            parameters=[
                {
                    "debug_mode": False,
                    ...
                    "input_topics": [
                        "/sensing/lidar/front_g32/pointcloud_before_sync",
                        "/sensing/lidar/rear_g32/pointcloud_before_sync",
                        "/sensing/lidar/left_pandar/pointcloud_before_sync",
                        "/sensing/lidar/right_pandar/pointcloud_before_sync",
                    ],
    ...
    nodes.append(
        ComposableNode(
            ...
            remappings=[
                ("input", "concatenated_raw/pointcloud"),
