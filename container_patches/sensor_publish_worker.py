...
#
# Ported as-is (2026-07-07) from upstream autoware_universe's
# simulator/autoware_carla_interface/src/autoware_carla_interface/modules/
# sensor_publish_worker.py (landed in autoware_launch 0.51.0, PR #11706),
# which our carla_ros.py fork predates. No local modifications.
