...
class MapView extends StatefulWidget {
  ...
  const MapView({super.key, required this.s, required this.lanes,
      this.polys = const [], required this.onTapWorld});
...
class _MapPainter extends CustomPainter {
  ...
  _MapPainter({required this.s, required this.lanes, required this.polys,
      ...
      required this.rot, this.trail = const []});
  ...
  void paint(Canvas c, Size size) {
    ...
    if (polys.isNotEmpty) {
      ...
      final lanePaint = Paint()..color = const Color(0xFF46484D);
    ...
    c.drawPath(body, Paint()..color = const Color(0xFF2A2C31));   // dark roof
    c.drawPath(body, Paint()
  ...
  bool shouldRepaint(covariant _MapPainter o) =>
      o.s != s || o.scale != scale || o.dest != dest || o.lanes != lanes || o.polys != polys || o.rot != rot;  // s carries routePath
}
